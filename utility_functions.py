...
def get_latent_embedding(smiles: str, charge_model: MBISGraphModel) -> tuple[torch.Tensor,rdkit.Chem]:
...
def total_latent_embeddings(smiles_list: list[str], charge_model: MBISGraphModel) -> torch.Tensor:
    """
