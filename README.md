...
| nagl-gas-charge-dipole-esp-wb-default   | Q, $\mu$, V | $\omega$ B79X-d/def2-TZVPP - MBIS Charges, QM Dipoles, ESP rebuilt to 1.4-2.0 $\times$ VdW with 0.5 $\AA$ spacing| gas    |
...
| nagl-water-charge-dipole-esp-wb-default | Q, $\mu$, V | $\omega$ B79X-d/def2-TZVPP - MBIS Charges, QM Dipoles, ESP rebuilt to 1.4-2.0 $\times$ VdW with 0.5 $\AA$ spacing | water |
| nagl-gas-esp-wb-2A            |Q, $\mu$, V | $\omega$ B79X-d/def2-TZVPP - MBIS Charges, QM Dipoles, ESP rebuilt to 1.4-2.0 $\times$ VdW with 2 $\AA$ spacing        | water    |
| nagl-gas-esp-wb-15A           | Q, $\mu$, V  | $\omega$ B79X-d/def2-TZVPP - MBIS Charges, QM Dipoles, ESP rebuilt to 1.4-2.0 $\times$ VdW with 1.5 $\AA$ spacing       | water    |
