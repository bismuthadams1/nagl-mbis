...
def create_parquet_dataset(
    ...
    cached_smiles = None
    for index,(key, smiles) in enumerate(zip(dataset_keys, dataset_smiles)):
        if index > 0:
            # print(recordscache)              
            ...
            if smiles != prev_smiles:
                ...
                recordscache = defaultdict(list)
        if key in reference_dataset.keys():
            singlepoint_record = reference_dataset[key]
...
for file_name, dataset_name in [
    ...
    create_parquet_dataset(
        ...
        reference_dataset=records_dict,
    )
