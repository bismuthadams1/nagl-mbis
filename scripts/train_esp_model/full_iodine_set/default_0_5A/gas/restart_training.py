...
def main():
    ...
    CHECKPOINT_PATH = "/home/mlpepper/bismuthadams.mlpepper/repos/nagl-mbis-release-for-training/nagl-mbis/scripts/train_esp_model/gas/1kcal_mol_denominator/default_0_5A/001-train-charge-model-small-mols/epoch=619-step=137020.ckpt"
    model_dict = torch.load("/home/mlpepper/bismuthadams.mlpepper/repos/nagl-mbis-release-for-training/nagl-mbis/scripts/train_esp_model/gas/1kcal_mol_denominator/default_0_5A/001-train-charge-model-small-mols/epoch=619-step=137020.ckpt")
    model = DGLMoleculeLightningModel.load_from_checkpoint(CHECKPOINT_PATH)

    # model = DGLMoleculeLightningModel(**model_dict['hyper_parameters'])
    ...
    trainer.test(model, datamodule=data, ckpt_path=CHECKPOINT_PATH)
